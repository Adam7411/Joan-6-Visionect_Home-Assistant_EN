...
## ⭐ Home Assistant Integration (Battery, Status, etc.)

For more integration (e.g., battery level, online status), use this HACS integration:
👉 [visionect\_joan](https://github.com/Adam7411/visionect_joan)
